        ...
        <div class="row">
                ...
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="create.php" class="btn btn-primary"><i class="bi bi-plus-square"> Crear nueva institución</i></a>
                        </div>
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                      <img src="<?php APP_URL."/public/images/configuracion/".$institucione['logo'];?>" width="100px" alt="">
                    </td>
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <form action="<?=APP_URL;?>/app/controllers/usuarios/delete.php" onclick="preguntar<?=$id_config_institucion;?>(event)" method="post" id="miFormulario<?=$id_config_institucion;?>">
                          <input type="text" name="id_usuario" value="<?=$id_config_institucion;?>" hidden>
